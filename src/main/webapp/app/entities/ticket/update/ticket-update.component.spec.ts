  ...
  describe('Ticket Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Project query and add missing value', () => {
        ...
        const project: IProject = { id: 42945 };
        ticket.project = project;

        const projectCollection: IProject[] = [{ id: 78375 }];
      ...
      it('Should call User query and add missing value', () => {
        const ticket: ITicket = { id: 456 };
        const assignedTo: IUser = { id: 85695 };
        ticket.assignedTo = assignedTo;

        const userCollection: IUser[] = [{ id: 68523 }];
      ...
      it('Should call Label query and add missing value', () => {
        const ticket: ITicket = { id: 456 };
        const labels: ILabel[] = [{ id: 30569 }];
        ticket.labels = labels;

        const labelCollection: ILabel[] = [{ id: 23606 }];
      ...
      it('Should update editForm', () => {
        const ticket: ITicket = { id: 456 };
        const project: IProject = { id: 70639 };
        ticket.project = project;
        const assignedTo: IUser = { id: 87155 };
        ticket.assignedTo = assignedTo;
        const labels: ILabel = { id: 4384 };
        ticket.labels = [labels];
